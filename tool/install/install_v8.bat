...
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icui18n.dll "%INSTALL_LIBDIR%\Debug"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icui18n.dll.lib "%INSTALL_LIBDIR%\Debug"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icui18n.dll.exp "%INSTALL_LIBDIR%\Debug"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icui18n.dll.pdb "%INSTALL_LIBDIR%\Debug"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icuuc.dll "%INSTALL_LIBDIR%\Debug"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icuuc.dll.lib "%INSTALL_LIBDIR%\Debug"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icuuc.dll.exp "%INSTALL_LIBDIR%\Debug"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.debug\icuuc.dll.pdb "%INSTALL_LIBDIR%\Debug"
...
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icui18n.dll "%INSTALL_LIBDIR%\Release"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icui18n.dll.lib "%INSTALL_LIBDIR%\Release"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icui18n.dll.exp "%INSTALL_LIBDIR%\Release"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icui18n.dll.pdb "%INSTALL_LIBDIR%\Release"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icuuc.dll "%INSTALL_LIBDIR%\Release"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icuuc.dll.lib "%INSTALL_LIBDIR%\Release"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icuuc.dll.exp "%INSTALL_LIBDIR%\Release"
%XCOPY% "%MODULE_ROOT%"\out.gn\x64.release\icuuc.dll.pdb "%INSTALL_LIBDIR%\Release"
