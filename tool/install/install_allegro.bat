@echo //----------------------------------------------------------------
@echo // brief:
@echo //   build and install allegro
@echo // usage:
@echo //   install_allegro.bat
@echo // version:
@echo //   $Id: install_allegro.bat 80 2012-07-01 07:35:59Z hryky.private@gmail.com $
@echo //----------------------------------------------------------------
...
set LIB=%DXSDK_DIR%\Lib\%TARGET_ARCHITECTURE%;%LIB%
